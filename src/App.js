  ...
  return (
    <div className="App">
      <div className="container-fluid">
        <h1 className="text-center text-4xl font-bold my-4">Galerie d'images</h1>
        <div className="flex items-center justify-center">
          ...
          />
          <button onClick={handleSearchClick} className="ml-2 px-4 py-2 bg-blue-500 text-black rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
            Rechercher
          </button>
        </div>
        <div className="row">
